...
model_save_str = 'lstm_KT_params_lr{}_epoch{}_batch{}_SeqLen{}_DP{}_LSTMHSize{}_Time{}'.format(LR, num_epochs, BatchSize, SeqLength,DropOut, LSTM_hiddenDim, dt.strftime('%Y-%m-%d %H:%M:%S'))
output_dim = 2
...
scheduler = lr_scheduler.ReduceLROnPlateau(optimizer, 'min', verbose=True, patience=4)
...
best_loss = 1e8
model_savePath = '../models/lstm_KT_lr{}_epoch{}_batch{}_SeqLen{}_DP{}_LSTMHSize{}_BestValLoss{}_Time{}.pkl'   \
           .format(LR, num_epochs, BatchSize, SeqLength,DropOut, LSTM_hiddenDim, best_loss, dt.strftime('%Y-%m-%d'))

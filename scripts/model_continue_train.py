...
model_save_str = 'continue_lstm_params_lr{}_epoch{}_batch{}_SeqLen{}_DP{}_LSTMHSize{}_Time{}'                         .format(LR, num_epochs, BatchSize, SeqLength,                                DropOut, LSTM_hiddenDim, dt.strftime('%Y-%m-%d %H:%M:%S'))
output_dim = 2
...
model_savePath = '../models/continue_lstm_AllSeq_lr{}_epoch{}_batch{}_SeqLen{}_DP{}_LSTMHSize{}_BestValLoss{}_Time{}.pkl'   \
